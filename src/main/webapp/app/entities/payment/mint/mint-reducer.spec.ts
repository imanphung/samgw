...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './mint.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MINT_LIST actions', async () => {
    ...
    it('dispatches FETCH_MINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MINT actions', async () => {
      const expectedActions = [
        {
