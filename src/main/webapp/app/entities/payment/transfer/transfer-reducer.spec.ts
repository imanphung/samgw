...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './transfer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSFER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRANSFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSFER actions', async () => {
      const expectedActions = [
        {
