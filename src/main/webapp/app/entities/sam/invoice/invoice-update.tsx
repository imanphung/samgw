...
export const InvoiceUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const updating = useAppSelector(state => state.samgw.invoice.updating);
  const updateSuccess = useAppSelector(state => state.samgw.invoice.updateSuccess);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="samgwApp.samInvoice.home.createOrEditLabel" data-cy="InvoiceCreateUpdateHeading">
            <Translate contentKey="samgwApp.samInvoice.home.createOrEditLabel">Create or edit a Invoice</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('samgwApp.samInvoice.studentId')}
              ...
              />
              <ValidatedField
                label={translate('samgwApp.samInvoice.lessonId')}
                id="invoice-lessonId"
                name="lessonId"
                data-cy="lessonId"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('samgwApp.samInvoice.transferId')}
              ...
              />
              <ValidatedField
                label={translate('samgwApp.samInvoice.status')}
                id="invoice-status"
                name="status"
                data-cy="status"
                type="select"
              ...
              <ValidatedField
                label={translate('samgwApp.samInvoice.createdAt')}
              ...
              />
              <ValidatedField
                label={translate('samgwApp.samInvoice.updatedAt')}
