...
export const SocialNetWorkDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="samgwApp.samSocialNetWork.delete.question">
        <Translate contentKey="samgwApp.samSocialNetWork.delete.question" interpolate={{ id: socialNetWorkEntity.id }}>
