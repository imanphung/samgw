...
export const LessonDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const updateSuccess = useAppSelector(state => state.samgw.lesson.updateSuccess);
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="samgwApp.samLesson.delete.question">
        <Translate contentKey="samgwApp.samLesson.delete.question" interpolate={{ id: lessonEntity.id }}>
