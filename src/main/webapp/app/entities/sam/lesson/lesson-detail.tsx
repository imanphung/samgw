...
export const LessonDetail = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const lessonEntity = useAppSelector(state => state.samgw.lesson.entity);
  return (
    <Row>
      <Col md="8">
        <h2 data-cy="lessonDetailsHeading">
          <Translate contentKey="samgwApp.samLesson.detail.title">Lesson</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="teacherId">
              <Translate contentKey="samgwApp.samLesson.teacherId">Teacher Id</Translate>
            </span>
          </dt>
          <dd>{lessonEntity.teacherId}</dd>
          <dt>
            <span id="title">
              <Translate contentKey="samgwApp.samLesson.title">Title</Translate>
            </span>
          </dt>
          <dd>{lessonEntity.title}</dd>
          <dt>
            <span id="content">
              <Translate contentKey="samgwApp.samLesson.content">Content</Translate>
            </span>
          </dt>
          <dd>{lessonEntity.content}</dd>
          <dt>
            <span id="price">
              <Translate contentKey="samgwApp.samLesson.price">Price</Translate>
            </span>
          </dt>
          <dd>{lessonEntity.price}</dd>
          <dt>
            <span id="time">
              <Translate contentKey="samgwApp.samLesson.time">Time</Translate>
            </span>
          </dt>
          <dd>{lessonEntity.time}</dd>
          <dt>
            <span id="createdAt">
              <Translate contentKey="samgwApp.samLesson.createdAt">Created At</Translate>
            </span>
          </dt>
          <dd>{lessonEntity.createdAt ? <TextFormat value={lessonEntity.createdAt} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="updatedAt">
              <Translate contentKey="samgwApp.samLesson.updatedAt">Updated At</Translate>
            </span>
          </dt>
