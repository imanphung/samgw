    ...
    <Row>
      <Col md="8">
        <h2 data-cy="roomDetailsHeading">
          <Translate contentKey="samgwApp.samRoom.detail.title">Room</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="meetingId">
              <Translate contentKey="samgwApp.samRoom.meetingId">Meeting Id</Translate>
            </span>
          </dt>
          <dd>{roomEntity.meetingId}</dd>
          <dt>
            <span id="createdBy">
              <Translate contentKey="samgwApp.samRoom.createdBy">Created By</Translate>
            </span>
          </dt>
          <dd>{roomEntity.createdBy}</dd>
          <dt>
            <span id="lessonId">
              <Translate contentKey="samgwApp.samRoom.lessonId">Lesson Id</Translate>
            </span>
          </dt>
          <dd>{roomEntity.lessonId}</dd>
          <dt>
            <span id="startTime">
              <Translate contentKey="samgwApp.samRoom.startTime">Start Time</Translate>
            </span>
          </dt>
          <dd>{roomEntity.startTime ? <TextFormat value={roomEntity.startTime} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="endTime">
              <Translate contentKey="samgwApp.samRoom.endTime">End Time</Translate>
            </span>
          </dt>
          <dd>{roomEntity.endTime ? <TextFormat value={roomEntity.endTime} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="status">
              <Translate contentKey="samgwApp.samRoom.status">Status</Translate>
            </span>
          </dt>
          <dd>{roomEntity.status}</dd>
          <dt>
            <span id="createdAt">
              <Translate contentKey="samgwApp.samRoom.createdAt">Created At</Translate>
            </span>
          </dt>
          <dd>{roomEntity.createdAt ? <TextFormat value={roomEntity.createdAt} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="updatedAt">
              <Translate contentKey="samgwApp.samRoom.updatedAt">Updated At</Translate>
            </span>
          </dt>
