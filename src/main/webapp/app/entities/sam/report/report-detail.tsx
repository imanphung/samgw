    ...
    <Row>
      <Col md="8">
        <h2 data-cy="reportDetailsHeading">
          <Translate contentKey="samgwApp.samReport.detail.title">Report</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="studentId">
              <Translate contentKey="samgwApp.samReport.studentId">Student Id</Translate>
            </span>
          </dt>
          <dd>{reportEntity.studentId}</dd>
          <dt>
            <span id="lessonId">
              <Translate contentKey="samgwApp.samReport.lessonId">Lesson Id</Translate>
            </span>
          </dt>
          <dd>{reportEntity.lessonId}</dd>
          <dt>
            <span id="comment">
              <Translate contentKey="samgwApp.samReport.comment">Comment</Translate>
            </span>
          </dt>
          <dd>{reportEntity.comment}</dd>
          <dt>
            <span id="star">
              <Translate contentKey="samgwApp.samReport.star">Star</Translate>
            </span>
          </dt>
          <dd>{reportEntity.star}</dd>
          <dt>
            <span id="createdAt">
              <Translate contentKey="samgwApp.samReport.createdAt">Created At</Translate>
            </span>
          </dt>
          <dd>{reportEntity.createdAt ? <TextFormat value={reportEntity.createdAt} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="updatedAt">
              <Translate contentKey="samgwApp.samReport.updatedAt">Updated At</Translate>
            </span>
          </dt>
