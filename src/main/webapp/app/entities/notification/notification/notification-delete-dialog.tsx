...
export const NotificationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="samgwApp.notificationNotification.delete.question">
        <Translate contentKey="samgwApp.notificationNotification.delete.question" interpolate={{ id: notificationEntity.id }}>
